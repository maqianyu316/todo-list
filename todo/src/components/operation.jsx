 ...
 * @LastEditTime: 2019-11-29 15:40:37
 * @LastEditors: xiaoma
 */
                ...
                <div className="progress">
                    {
                        ...
                        :
                        <div className="progress-bar progress-bar-warning progress-bar-striped" 
                            role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" style={{width: `${radio}%`}}>                        
                        </div>
                    }
                </div>
                <button type="button" className="btn btn-info" onClick={()=>{this.clearFinished()}}>清除完成项</button>
            </div>
         </div>
        );
    }
